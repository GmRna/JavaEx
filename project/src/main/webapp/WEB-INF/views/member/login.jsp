					...
					<div class="box">
						<fieldset class="login_form">
							<ul>
								...
								<li><input type="password" id="pwd1" name="pwd" placeholder="비밀번호" autocomplete="off"></li>
						...
						<div class="btnSet clear">
							<div>
								<a href="join.do" class="btn">회원가입</a> <a href="idsearch.do" class="btn">이메일/비밀번호 찾기</a>
							</div>
						</div>
					</div>
				</div>
